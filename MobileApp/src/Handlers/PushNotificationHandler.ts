...
export const SendLocalPushNotification = (notification: PushNotificationObj) => {
    PushNotification.localNotification({
        ...
        largeIconUrl: notification.image, // (optional) default: undefined
        smallIcon: "ic_notification", // (optional) default: "ic_notification" with fallback for "ic_launcher". Use "" for default small icon.
        bigText: notification.body, // (optional) default: "message" prop
        subText: notification.body, // (optional) default: none
        bigPictureUrl: notification.image, // (optional) default: undefined
        bigLargeIcon: "ic_launcher", // (optional) default: undefined
        bigLargeIconUrl: notification.image, // (optional) default: undefined
        ...
        picture: notification.image, // (optional) Display an picture with the notification, alias of `bigPictureUrl` for Android. default: undefined
...
export const ConfigurePushNotifications = () => {
    ...
    PushNotification.configure({
        ...
        onNotification: function (notification) {
            ...
            console.log(notification.data.largeIconUrl)
            let pushNotification = new PushNotificationObj(
                notification.data.title,
                notification.data.body,
                notification.data.image,
                notification.data.bigPictureUrl,
