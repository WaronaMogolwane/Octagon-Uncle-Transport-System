...
export const FormControlInput = (props: FormControlProps) => {
    return (
        <FormControl isInvalid={props.isValid} size={props.size} isDisabled={props.isDisabled} isRequired={props.isRequired}>
            <FormControlLabel>
                <FormControlLabelText>{props.labelText}</FormControlLabelText>
            </FormControlLabel>
            <Input>
                <InputField type={props.type} defaultValue={props.defaultValue} placeholder={props.placeHolder} />
            </Input>
